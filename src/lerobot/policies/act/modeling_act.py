...
from lerobot.utils.vit_backbones import (  # noqa: F401 — re-exported for backward compatibility
    CpMaeBackboneWrapper,
    ...
    def __init__(self, config: ACTConfig):
        ...
        if self.config.image_features:
            if config.vision_backbone.startswith("resnet"):
                ...
                self.backbone = vit_wrapper
                backbone_out_channels = vit_wrapper.hidden_size
